...
prob_metrics = metrics_df.dropna(subset=['metrics.conversion_probability']).sort_values('startTimeStampMs')
sns.lineplot(x=range(len(prob_metrics)), y="metrics.conversion_probability", data=prob_metrics, color='grey')
