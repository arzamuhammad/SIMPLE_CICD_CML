...
c.executemany('INSERT INTO spark_pipelines VALUES (?,?,?,?)', pipelines_insert)
c.executemany('INSERT INTO spark_models VALUES (?,?,?,?)', models_insert)
...
conn = sqlite3.connect('models.db')
c = conn.cursor()
for i in c.execute("select * from spark_pipelines"): print(i)
for i in c.execute("select * from spark_models"): print(i)
